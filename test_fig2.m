...
c_bpmf=yc_coh(d_bpmf,Param);
c_bpmfmrr=yc_coh(d_bpmfmrr,Param);
...
ax2=subplot(4,2,2);
yc_imagesc(data,95,1,t,x);colormap(ax2,seis);
...
ax3=subplot(4,2,3);
yc_imagesc(datat,95,1,t,x);colormap(ax3,seis);title('BP+MF');
...
ax4=subplot(4,2,4);
yc_imagesc(datatt,95,1,t,x);colormap(ax4,seis);title('BP+MF+MRR');
